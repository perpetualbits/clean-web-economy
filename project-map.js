...
window.PROJECT_MAP = {
  ...
  nodes: [
    ...
    // ---- On-chain contracts --------------------------------------------
    {
      ...
      status: "active",
      tags: ["H6"],
      desc: "Replaces the owner-managed 'verified creator' and juror allowlists with revocable, expiring verifiable credentials: a rotatable issuer set attests; the registry and jury verify. The current cycle.",
      files: ["docs/superpowers/specs/2026-07-24-verifiable-credentials-design.md"],
      parts: [
        { label: "Issue / verify / expire / revoke", status: "active", desc: "isValid = exists ∧ ¬revoked ∧ ¬expired ∧ issuer still trusted." },
    ...
    },
    {
      ...
      parts: [
        ...
        { label: "Credential-gated", status: "active", desc: "H6 swaps the allowlist for CWEIdentity.isValid." },
      ],
    ...
    },
    {
      ...
      parts: [
        ...
        { label: "Credential-gated jurors", status: "active", desc: "H6 swaps the juror allowlist for CWEIdentity." },
    ...
    // ---- Devnet & CI ----------------------------------------------------
    {
      ...
      parts: [
        ...
        { label: "identity", status: "active", desc: "H6: the credential lifecycle demo." },
      ],
      specs: [],
  ...
  roadmap: [
    ...
    { id: "h6", kind: "harden", label: "H6 — Verifiable credentials / identity", status: "active" },
