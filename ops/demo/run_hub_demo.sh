...
manifest() { cat <<JSON
{"work_id":"$WORK_ID","fingerprint":"$FP","title":"Blue Ocean","description":"demo","tags":["calm"],"work_type":"audio","price_per_min":1000000,"bandwidth_rate":0,"region":"$EU","creator_id":"$1","created_at":1,"content_id":"$CONTENT_ID","payees":[["$PAYEE",1000000]]}
JSON
}
